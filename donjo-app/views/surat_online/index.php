...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Layanan Surat Online</li>
		</ol>
	</section>
											...
											<div class="col-sm-3">
												<div class="box-tools">
													<div class="input-group input-group-sm pull-right">
														<input name="cari" id="cari" class="form-control" placeholder="Cari Nama / NIK" type="text" value="<?=html_escape($cari)?>" onkeypress="if (event.keyCode == 13){$('#'+'mainform').attr('action', '<?=site_url("{$this->controller}/search")?>');$('#'+'mainform').submit();}">
...
<table class="table table-bordered dataTable table-striped table-hover">
	<thead class="bg-gray disabled color-palette">
		<tr>
			...
			<th >Jenis Surat</th>
			<?php if ($o==2): ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/1")?>">NIK <i class='fa fa-sort-asc fa-sm'></i></a></th>
			<?php elseif ($o==1): ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/2")?>">NIK <i class='fa fa-sort-desc fa-sm'></i></a></th>
			<?php else: ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/1")?>">NIK <i class='fa fa-sort fa-sm'></i></a></th>
			<?php endif; ?>

			<?php if ($o==4): ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/3")?>">Nama Penduduk <i class='fa fa-sort-asc fa-sm'></i></a></th>
			<?php elseif ($o==3): ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/4")?>">Nama Penduduk <i class='fa fa-sort-desc fa-sm'></i></a></th>
			<?php else: ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/3")?>">Nama Penduduk <i class='fa fa-sort fa-sm'></i></a></th>
			<?php endif; ?>
			<th>Email</th>
			<th nowrap>Status</th>
			<th nowrap>Keterangan</th>
			<?php if ($o==6): ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/5")?>">Waktu Dikirim <i class='fa fa-sort-asc fa-sm'></i></a></th>
			<?php elseif ($o==5): ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/6")?>">Waktu Dikirim <i class='fa fa-sort-desc fa-sm'></i></a></th>
			<?php else: ?>
				<th nowrap><a href="<?= site_url("surat_online/index/$p/5")?>">Waktu Dikirim <i class='fa fa-sort fa-sm'></i></a></th>
			<?php endif; ?>
		</tr>
	</thead>
	<tbody>
		...
		?>
			<tr>
				<td><?= $data['no']?></td>
				<td nowrap>
					<a href="<?= base_url("index.php/surat/form/") ?><?= $data['url_surat']."/".$data['id_penduduk'] ?>" class="btn btn-social btn-flat bg-purple btn-sm" title="Cetak Surat" target="_blank"><i class="fa fa-file-word-o"></i> Cetak Surat</a>						

					<a href="#" data-href="<?= site_url("surat_online/delete/$p/$o/$data[id]")?>" class="btn bg-maroon btn-flat btn-sm"  title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
				</td>
				...
				<td nowrap class="text-center"><span style="padding:0.5em" class="bg-<?= $data['read'] == 0 ? "danger":"success" ?>"><?= $data['read'] == 0 ? "Belum":"Sudah" ?> Dibaca</span></td>
