...
class Surat_online_model extends CI_Model {
	...
	private function filter_sql()
	{
		if (isset($_SESSION['filter']))
		{
			...
			if ($kf == "0")
				...
				$filter_sql = " AND YEAR(u.created_at) = '".$kf."'";
			return $filter_sql;
		}
	}
	...
	{
		$sql = " FROM tweb_surat_online u join tweb_surat_format k on u.jenis_surat_id = k.id join tweb_penduduk p on u.nik = p.nik";
		$sql .= $this->search_sql();
		$sql .= $this->filter_sql();
		$sql .= $this->jenis_sql();
		return $sql;
	...
	public function list_data($o=0, $offset=0, $limit=500)
	{
		...
		switch ($o)
		{
			case 1: $order_sql = ' ORDER BY u.nik * 1'; break;
			case 2: $order_sql = ' ORDER BY u.nik * 1 DESC'; break;
			case 3: $order_sql = ' ORDER BY nama'; break;
			case 4: $order_sql = ' ORDER BY nama DESC'; break;
			case 5: $order_sql = ' ORDER BY u.created_at'; break;
			case 6: $order_sql = ' ORDER BY u.created_at DESC'; break;

			default:$order_sql = ' ORDER BY u.created_at DESC';
		}
		...
		//Main Query
		$select_sql = "SELECT u.*, p.id as id_penduduk, k.nama as nama_surat, k.url_surat ";
	...
	public function delete($id='')
	{
		...
		if (!$this->db->where('id', $id)->delete('tweb_surat_online'))
