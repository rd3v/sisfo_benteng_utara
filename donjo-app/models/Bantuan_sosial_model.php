...
class Bantuan_sosial_model extends CI_Model {
	...
	public function full_bantuan($offset=0, $limit=50)
	{
		...
		$sql = "SELECT program.nama AS program,tweb_penduduk.nama AS nama,tweb_penduduk.nik AS nik, program.alamat AS alamat FROM program,program_peserta,tweb_penduduk WHERE program.id = program_peserta.program_id && program_peserta.kartu_nik = tweb_penduduk.nik";
