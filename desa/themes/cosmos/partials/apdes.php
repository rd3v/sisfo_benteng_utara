		...
		<div class="col-12 px-0">
			<div class="row widget mx-auto justify-content-center">
				<div class="col-lg-4 px-1 px-lg-3">
					<div class="box bg-white">
						<div class="box-header">
							<h3 class="box-title bg-danger">Anggaran Tahun 2019</h3>
						</div>
						<div class="box-body my-4">
							<div class="item-apdes mb-2">
								<span class="small font-weight-bold">Pendapatan Asli Kelurahan</span>
							...
							<div class="item-apdes mb-2">
								<span class="small font-weight-bold">Alokasi Dana Kelurahan</span>
								<div class="d-flex justify-content-between w-100 pb-2 small">
							...
							<div class="item-apdes mb-2">
								<span class="small font-weight-bold">Dana Kelurahan</span>
								<div class="d-flex justify-content-between w-100 pb-2 small">
				...
				<div class="col-lg-4 px-1 px-lg-3">
					<div class="box bg-white">
						<div class="box-header">
							<h3 class="box-title bg-info">APBDes Tahun 2018</h3>
						</div>
						<div class="box-body my-4">
							<div class="item-apdes mb-2">
				...
				<div class="col-lg-4 px-1 px-lg-3">
					<div class="box bg-white">
						<div class="box-header">
							<h3 class="box-title bg-warning">Realisasi APBDes 2018</h3>
						</div>
						<div class="box-body my-4">
							<div class="item-apdes mb-2">
								<span class="small font-weight-bold">Penyelenggaraan Pemerintahan Kelurahan</span>
								<div class="d-flex justify-content-between w-100 pb-2 small">
							...
							<div class="item-apdes mb-2">
								<span class="small font-weight-bold">Pelaksanaan Pembangunan Kelurahan</span>
								<div class="d-flex justify-content-between w-100 pb-2 small">
