			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN BERHENTI USAHA</h4></u></div>
					...
					<div id="isi3">
						...
						<tr><td>
							<table width="100%">
								...
								<tr><td>12. Nama Usaha </td><td>:</td><td><?= $input['nama_usaha']?></td></tr>
								<tr>
									<td colspan="3"><p></p></td>
								</tr>
								<tr>
									<td colspan="3">
										<p>
											Menerangkan dengan sebenarnya bahwa tersebut di atas adalah <b>BENAR</b> penduduk Lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara,Kecamatan Benteng, Kabupaten Kepulauan Selayar, sudah tidak menjalankan Kegiatan Usaha <?= $input['nama_usaha'] ?>
										</p>
									</td>
								</tr>
