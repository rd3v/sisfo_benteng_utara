			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN KELAKUAN BAIK</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									...
									<td>
										<p>
											Bahwa yang tersebut namanya di atas adalah BENAR Penduduk Lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara,Kecamatan Benteng, Kabupaten Kepulauan Selayar, yang selama dalam pengetahuan kami benar – benar berkelakuan baik dan tidak pernah terlibat dalam Tindak Pidana / Kriminal.
										</p>
									</td>
								</tr>
