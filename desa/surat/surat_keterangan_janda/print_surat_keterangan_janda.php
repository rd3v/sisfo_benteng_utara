			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN JANDA</h4></u></div>
					...
					<div id="isi3">
						...
						<tr><td>
							<table width="100%">
								...
								<tr><td><p></p></td></tr>
								<tr>
									<td colspan="3"><p>Adalah <b>BENAR</b> JANDA dari laki – laki :</p></td>
								</tr>
<tr><td width="20%">a. Nama</td><td width="2%">:</td><td width="64%"><?= unpenetration($input['nama_suami'])?></td></tr>
<tr><td>b. Tempat / Tanggal Lahir</td><td>:</td><td><?= ($input['tempat_lahir_suami'])?>, <?= tgl_indo($input['tanggal_lahir_suami'])?></td></tr>
<tr><td>c. Pekerjaan</td><td>:</td><td><?= $input['pekerjaan_suami'] ?></td></tr>
<tr><td>c. Alamat</td><td>:</td><td>RT. <?= $data['rt']?>, RW. <?= $data['rw']?>, Dusun <?= ununderscore(unpenetration($data['dusun']))?>, Kelurahan <?= unpenetration($desa['nama_desa'])?>, Kec. <?= unpenetration($desa['nama_kecamatan'])?>, Kab. <?= unpenetration($desa['nama_kabupaten'])?></td></tr>
								<tr><td>&nbsp;</td></tr>
								<tr>
									<td colspan="3">
										<p>
