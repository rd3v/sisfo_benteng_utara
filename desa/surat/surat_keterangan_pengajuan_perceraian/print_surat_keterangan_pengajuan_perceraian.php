			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN PENGAJUAN PERCERAIAN</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									<td colspan="3">
										<p>
											Bahwa yang tersebut namanya di atas Benar berkeinginan menggugat cerai [form_nama_digugat] yang bernama <?= $input['nama_digugat'] ?> Bin <?= $input['nama_digugat_bin'] ?>, karena sudah tidak ada lagi kecocokan (telah pisah rumah selama kurang lebih <?= $input['waktu_pisah_rumah'] ?>) yang beralamat di jalan <?= $data['alamat'] ?> Lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara Kecamatan Benteng Kabupaten Kepulauan Selayar berdasarkan Kutipan Akta Nikah Nomor : <?= $input['akta_nomor_nikah'] ?>
										</p>
									</td>
								</tr>
