			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN BELUM MEMILIKI RUMAH</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									...
									<td>
										<p>
											Bahwa yang tersebut namanya di atas Benar Penduduk Lingkungan <?= $data['dusun'] ?> Kelurahan Benteng Utara Kecamatan Benteng Kabupaten Kepulauan Selayar, yang sampai saat ini selama dalam pengetahuan kami benar belum memiliki rumah (tinggal di rumah kontrakan)
										</p>
									</td>
								</tr>
