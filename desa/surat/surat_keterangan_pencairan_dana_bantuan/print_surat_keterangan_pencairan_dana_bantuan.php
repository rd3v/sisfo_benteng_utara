			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN PENCAIRAN DANA BANTUAN</h4></u></div>
					...
					<div id="isi3">
						...
						<tr><td>
							<table width="100%">
								...
								<tr><td>12. Keperluan </td><td>:</td><td>Mencairkan Dana Bantuan PIP di BRI</td></tr>
								<tr>
									<td colspan="3"><p></p></td>
								</tr>
