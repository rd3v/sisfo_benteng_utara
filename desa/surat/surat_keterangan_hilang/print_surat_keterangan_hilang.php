						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									<td colspan="3">
										<p>
											 Bahwa yang tersebut di atas adalah <b>BENAR</b> berdomisili di Lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara, telah kehilangan Kartu Keluarga ( KK ) dengan nomor Kartu Keluaraga ( KK ) : <?= $data['no_kk'] ?>.
										</p>
									</td>
								</tr>
