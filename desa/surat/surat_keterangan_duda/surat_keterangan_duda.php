				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="tanggal_meninggal_istri"  class="col-sm-3 control-label">Tanggal Meninggal Istri</label>
								<div class="col-sm-3 col-lg-2">
									<div class="input-group input-group-sm date">
										<div class="input-group-addon">
											<i class="fa fa-calendar"></i>
										</div>
										<input title="Pilih Tanggal" id="tgl_mulai" class="form-control input-sm required" name="tanggal_meninggal_istri" type="text"/>
									</div>
								</div>
							</div>
