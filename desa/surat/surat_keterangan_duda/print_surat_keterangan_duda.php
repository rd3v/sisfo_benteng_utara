			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN DUDA</h4></u></div>
					...
					<div id="isi3">
						...
						<tr><td>
							<table width="100%">
								...
								<tr><td><p></p></td></tr>
								<tr>
									<td colspan="3"><p>Adalah <b>BENAR</b> DUDA dari laki – laki :</p></td>
								</tr>
<tr><td width="20%">a. Nama</td><td width="2%">:</td><td width="64%"><?= unpenetration($data['nama'])?></td></tr>
<tr><td>b. Tempat / Tanggal Lahir</td><td>:</td><td><?= ($data['tempatlahir'])?>, <?= tgl_indo($data['tanggallahir'])?></td></tr>
<tr><td>c. Pekerjaan</td><td>:</td><td><?= $data['pekerjaan'] ?></td></tr>
<tr><td>c. Alamat</td><td>:</td><td>RT. <?= $data['rt']?>, RW. <?= $data['rw']?>, Dusun <?= ununderscore(unpenetration($data['dusun']))?>, Kelurahan <?= unpenetration($desa['nama_desa'])?>, Kec. <?= unpenetration($desa['nama_kecamatan'])?>, Kab. <?= unpenetration($desa['nama_kabupaten'])?></td></tr>
								...
								<tr>
									<td colspan="3">
										<p>
Bahwa yang tersebut namanya di atas setelah Istrinya meninggal pada tanggal <?= $input['tanggal_meninggal_istri'] ?> selama dalam pengetahuan kami memang belum menikah lagi. Demikian Surat Keterangan ini dibuat dan dan diberikan kepada yang bersangkutan untuk digunakan sebagaimana mestinya.
										</p>
									</td>
								</tr>
