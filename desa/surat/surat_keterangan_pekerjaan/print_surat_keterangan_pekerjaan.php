			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN PEKERJAAN</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									...
									<td>
										<p>
											Bahwa yang tersebut namanya di atas adalah <b>Benar</b> Penduduk Lingkungan <?= ['lingkungan'] ?> Kelurahan Benteng Utara Kecamatan Benteng Kabupaten Kepulauan Selayar, dan benar seorang <?= $data['pekerjaan'] ?>.
										</p>
									</td>
								</tr>
