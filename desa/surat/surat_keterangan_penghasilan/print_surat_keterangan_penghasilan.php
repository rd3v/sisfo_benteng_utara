			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN PENGHASILAN</h4></u></div>
					...
					<div id="isi3">
						...
						<tr><td>
							<table width="100%">
								...
								<tr><td><p></p></td></tr>
								<tr>
									<td colspan="3"><p>Adalah <b>BENAR</b> Anak Kandung dari :</p></td>
								</tr>
<tr><td width="20%">a. Nama</td><td width="2%">:</td><td width="64%"><?= unpenetration($input['nama_suami'])?></td></tr>
<tr><td>b. Tempat / Tanggal Lahir</td><td>:</td><td><?= ($input['tempat_lahir_ortu'])?>, <?= tgl_indo($input['tanggal_lahir_ortu'])?></td></tr>
<tr><td>c. Jenis Kelamin</td><td>:</td><td><?= $input['jk_ortu'] ?></td></tr>
<tr><td>d. Pekerjaan</td><td>:</td><td><?= $input['pekerjaan_ortu'] ?></td></tr>
<tr><td>e. Alamat</td><td>:</td><td>RT. <?= $input['alamat_ortu']?></td></tr>
								<tr>
									<td><p><b>&nbsp;&nbsp;&nbsp;&nbsp;Maksud</b></p></td>
									<td><p>:</p></td>
									<td>
										<p>
Bahwa yang tersebut namanya di atas adalah Benar penduduk lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara Kecamatan Benteng Kabupaten Kepulauan Selayar, dengan penghasilan setiap bulan Rp<?= number_format($input['nominal_penghasilan']) ?> <?= $input['terbilang_penghasilan'] ?> Rupiah.
									</td>
								</tr>
								<tr>
									<td colspan="3">
										<p>
Bahwa yang tersebut namanya di atas suaminya meninggal pada tanggal <?= $input['tanggal_meninggal_suami'] ?> selama dalam pengetahuan kami memang belum menikah lagi. Demikian Surat Keterangan ini dibuat dan dan diberikan kepada yang bersangkutan untuk digunakan sebagaimana mestinya.
										</p>
									</td>
								</tr>
