			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN MENGIKUTI PROGRAM BEASISWA</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									...
									<td>
										<p>
											Bahwa yang tersebut namanya di atas adalah <b>BENAR</b> Penduduk Lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara,Kecamatan Benteng, Kabupaten Kepulauan Selayar, yang sampai saat ini selama dalam pengetahuan kami masih berstatus sebagai mahasiswa di int. University Of Africa sudah (Mengikuti Program Beasiswa S1 Perguruan Tinggi Luar Negeri Sudan).
										</p>
									</td>
								</tr>
