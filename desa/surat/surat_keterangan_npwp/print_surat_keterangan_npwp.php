			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN NPWP</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									<td colspan="3">
										<p>
Bahwa yang namanya tersebut di atas adalah <b>BENAR</b> penduduk di Lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara,Kecamatan Benteng, Kabupaten Kepulauan Selayar, bermaksud untuk mengurus Nomor Pokok Wajib Pajak ( NPWP ).
										</p>
									</td>
								</tr>
