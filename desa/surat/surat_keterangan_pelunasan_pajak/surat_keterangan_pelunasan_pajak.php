				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="keterangan"  class="col-sm-3 control-label">Tahun Pajak Lunas</label>
								<div class="col-sm-8">
									<input  id="tahun_pajak_lunas" class="form-control input-sm required" type="number" placeholder="Tahun Pajak Lunas" name="tahun_pajak_lunas" value="">
								</div>
							</div>
