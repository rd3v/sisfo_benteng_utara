			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN PELUNASAN PAJAK</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									...
									<td>
										<p>
											Bahwa yang tersebut di atas adalah penduduk Lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara Kecamatan Benteng Kabupaten Kepulauan Selayar, <b>BENAR</b> sudah melunasi Pajak Tahun <?= $input['tahun_pajak_lunas'] ?>.
										</p>
									</td>
								</tr>
