			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN BIAYA PENGGUNAAN LISTRIK</h4></u></div>
					...
					<div id="isi3">
						...
						<tr><td>
							<table width="100%">
								...
								<tr><td><p></p></td></tr>
								<tr>
									<td colspan="3"><p>Nama tersebut di atas adalah Orang Tua :</p></td>
								</tr>
<tr><td width="20%">a. Nama</td><td width="2%">:</td><td width="64%"><?= unpenetration($input['nama_anak'])?></td></tr>
<tr><td>b. Tempat / Tanggal Lahir</td><td>:</td><td><?= $input['tempat_lahir'] ?>, <?= $input['tanggal_lahir'] ?></td></tr>
								<tr><td>&nbsp;</td></tr>
								<tr>
									<td colspan="3">
										<p>
Menyatakan biaya penggunaan listrik yang saya keluarkan perbulannya kurang lebih Rp<?= number_format($input['biaya_awal']) ?>   s/d Rp<?= number_format($input['biaya_akhir']) ?> / bulan. Demikian Surat Keterangan ini dibuat dan dan diberikan kepada yang bersangkutan untuk digunakan sebagaimana mestinya.
										</p>
									</td>
								</tr>
