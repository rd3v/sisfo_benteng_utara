			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN DOMISILI USAHA</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									...
									<td>
										<p>
											Bahwa Perusahaan yang tersebut di atas Benar  Berdomisili di Jalan <?= $data['alamat'] ?> Lingkungan <?= $input['lingkungan'] ?> Kelurahan Benteng Utara Kecamatan Benteng Kabupaten Kepulauan Selayar sejak tahun <?= $input['tahun_berdiri'] ?>
										</p>
									</td>
								</tr>
