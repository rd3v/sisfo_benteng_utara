			...
			<div id="content-main" class="grid_7">
				...
				<div>
					<table width="100%">
						...
						<tr>
							<td>
						<div align="center"><u><h4 class="kop3">SURAT KETERANGAN PENYESUAIAN KTP</h4></u></div>
						...
						<tr><td>
							<table width="100%">
								...
								<tr>
									<td colspan="3">
										<p>
Menerangkan dengan sebenarnya bahwa atas nama <?= $input['nama'] ?> adalah orang yang sama dengan <?= $input['nama'] ?> sesuai yang tertera pada Kartu Tanda Penduduk ( KTP ) dengan Nomor Induk Kependudukan ( NIK ) Nomor : <?= $input['nik'] ?> 											
										</p>
									</td>
								</tr>
