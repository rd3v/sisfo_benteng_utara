				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="keperluan"  class="col-sm-3 control-label">Nomor KTP</label>
								<div class="col-sm-8">
									<input  id="nik" class="form-control input-sm required" type="number" placeholder="Nomor KTP" name="nik">
								</div>
							</div>
